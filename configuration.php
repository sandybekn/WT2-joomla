...
class JConfig
{
	...
	public $user = 'lmiowl_jos3';                       // DB username
	public $password = 'N[K^K9#DE0JEUb(f3@[90[.1';                   // DB password
	public $db = 'lmiowl_jos3';                         // DB database name
	public $dbprefix = 'jos_';               // Do not change unless you need to!

	/* Server Settings */
	public $secret = 'kYgJfMyZlG4rzaBC';     // Change this to something more secure
	public $gzip = '0';
	...
	public $ftp_enable = '';
	public $tmp_path = '/home/lmiowl/nurzhamal.owlstudio.kz/tmp';                // Please check with your host that this is the correct path to the temp directory. This path needs to be writable by Joomla!
	public $log_path = '/home/lmiowl/nurzhamal.owlstudio.kz/logs';           // Please check with your host that this is the correct path to the logs directory. This path needs to be writable by Joomla!
